...
The source code for the app, intended to be suitable for educational purposes, is available under a GNU General Public License v3.0 from Marc's GitHub repository.
    """.trimIndent()
